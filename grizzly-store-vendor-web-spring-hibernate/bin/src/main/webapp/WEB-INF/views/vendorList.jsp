...
<!-- 			<th>vendor id</th> -->
	...
	<c:url var="updateLink" value="/updateVendor">
		<c:param name="vendor_id" value="${tempVendor.vendor_id}"></c:param>
	</c:url>
	
	<!-- construct an delete link with book id -->
	<c:url var="deleteLink" value="/deleteVendor">
		<c:param name="vendor_id" value="${tempVendor.vendor_id}"></c:param>
	</c:url>
	
	<!-- construct an view link with book id -->
	<c:url var="viewLink" value="/viewVendor">
		<c:param name="vendor_id" value="${tempVendor.vendor_id}"></c:param>
	</c:url>
...
<%-- 			<td>${tempProduct.product_id}</td> --%>
			...
			<td>
				...
				<a href="${deleteLink}"
				onclick="if (!(confirm('Are you sure you want to delete this vendor?'))) return false"><button type="button" class="btn btn-outline-danger">Delete</button></a>
...
<br>
<button type="button" class="btn btn-primary" onclick="window.location.href='showVendor'; return false">Add Vendor</button>
</div>
</div>
</div>
</div>
